...
app.layout = html.Div([
    ...
    dcc.Upload(
        id='upload-data',
        children=html.Div([
            html.A('Select Files', style={'font-size': '24px',
                                          'font-family': 'Arial',
                                          'font-weight': 'bold',
                                          'color': '#00698f',
                                          'marginTop': '10px',
...
if __name__ == '__main__':
    #app.run_server(debug=True, host='0.0.0.0', port=6556)
    ssl_context = ('/home/cslgipuzkoa/virtual_machine_disk/Data_repository/cert.pem','/home/cslgipuzkoa/virtual_machine_disk/Data_repository/key.pem')
